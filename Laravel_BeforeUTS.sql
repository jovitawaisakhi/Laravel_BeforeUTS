...
--
-- Host: localhost
-- Generation Time: Nov 07, 2024 at 05:56 PM
...
CREATE TABLE `writers` (
  ...
  `WriterSpesialis` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `WriterImage` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `articles`
  MODIFY `ArticleID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
